...
export default function AdminDashboard() {
  ...
  const handleSubjectSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('📝 Submitting subject:', editingSubject ? 'UPDATE' : 'CREATE', subjectForm);
      ...
      if (response.ok) {
        ...
        setError(errorMsg || 'Failed to save subject');
        console.error('❌ Subject save error:', data);
      }
    } catch (error: any) {
      console.error('❌ Subject submit exception:', error);
