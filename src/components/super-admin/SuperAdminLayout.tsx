...
const SuperAdminLayout: React.FC<SuperAdminLayoutProps> = ({ children, activeTab }) => {
    ...
    const navItems = [
        ...
        { id: 'calendars', icon: Calendar, label: 'Calendars', path: '/super-admin/calendars' },
        { id: 'demoRequests', icon: ClipboardList, label: 'Demo Requests', path: '/super-admin/demo-requests' },
        { id: 'registrationTokens', icon: Key, label: 'Registration Tokens', path: '/super-admin/registration-tokens' },
        { id: 'settings', icon: Settings, label: 'Settings', path: '/super-admin/settings' },
        { id: 'analytics', icon: BarChart3, label: 'Analytics', path: '/super-admin/analytics' },
    ];


    if (!user) {
        return <PageLoader message="Loading Super Admin Console" subMessage="Verifying your session..." />;
    }
        ...
        <div className="min-h-screen bg-gradient-to-br from-[#CDE8E5] via-[#EEF7FF] to-[#7AB2B2]">
            ...
            <header className="fixed top-0 left-0 right-0 h-[70px] bg-gradient-to-r from-[#4D869C] to-[#7AB2B2] shadow-lg z-50 flex items-center justify-between px-8">
                <div className="flex items-center gap-4">
                    ...
                    <h1 className="text-white text-[22px] font-bold">Algomate</h1>
                </div>
                                    ...
                                    <div className="p-5 border-b border-gray-100 bg-gray-50/50">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <div className="flex justify-between items-center text-xs">
                                                ...
                                                <span className="text-[#4D869C] font-bold bg-[#4D869C]/10 px-2 py-0.5 rounded">Super Admin</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="p-2">
            ...
            <motion.aside
                ...
                className="fixed top-[70px] left-0 h-[calc(100vh-70px)] bg-white/80 backdrop-blur-lg shadow-xl z-40 overflow-hidden"
            >
                <div className="relative flex items-center p-6 mb-2 h-[80px]">
                    <div className="min-w-[42px] flex justify-center items-center">
                        <Shield size={32} className="text-[#4D869C]" />
                    </div>
                    <motion.div
                        initial={{ opacity: 0 }}
                    ...
                    >
                        <h2 className="text-xl font-bold text-gray-800 m-0">Super Admin</h2>
                    </motion.div>
                </div>
                ...
                <nav className="flex flex-col gap-2 px-3">
                    {navItems.map(({ id, icon: Icon, label, path }) => (
                        <button
                            ...
                            className={`group flex items-center gap-4 px-3 py-3 rounded-xl transition-all cursor-pointer border-none overflow-hidden whitespace-nowrap ${activeTab === id
