        ...
        <CollegeAdminLayout activeTab="classrooms">
            <div className="space-y-6">
                ...
                <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
                    {loading ? <CardLoader message="Loading classrooms..." subMessage="Fetching classroom inventory" /> : filteredClassrooms.length === 0 ? <div className="text-center py-12 text-gray-500">No classrooms found</div> : (
                                    ...
                                    <motion.tr key={room.id} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: i * 0.03 }} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex gap-2">
                                                ...
                                                <button onClick={() => handleDelete(room)} className="p-2 text-red-600 hover:bg-red-50 rounded-lg"><Trash2 size={16} /></button>
                                            </div>
                                        </td>
                                    </motion.tr>
                                ))}
