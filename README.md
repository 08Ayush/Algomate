...
### 1. Hybrid AI Timetable Generation

**Algorithm Flow**:
```
Input: Batches, Subjects, Faculty, Constraints
  ↓
[Phase 1] CP-SAT Solver
...
[Phase 3] Reinforcement Learning
  - PPO agent learns from feedback
  - Continuous improvement
  ↓
Output: Optimized Conflict-Free Timetable
```

### 2. NEP 2020 Subject Selection System

**MAJOR Lock Mechanism**:
```
Semester 1-2: Free exploration
      ↓
Semester 3: Student selects MAJOR
      ↓
   [LOCKED] ← MAJOR domain is permanent
      ↓
Semester 4-8: Must continue in same domain
```

### 3. Department-Based Data Isolation

Every API endpoint filters data by:
```typescript
...
- **Department Isolation**: Data segregation
...
- **Our Mentors** Prof. Yogita Nikhare and Prof. Kavita Meshram
- **Open Source Communities** for amazing tools and libraries
- **Our Institution** for support and resources
...
- **GitHub**: [08Ayush/academic_campass_2025](https://github.com/08Ayush/academic_campass_2025)
- **Issue Tracker**: [GitHub Issues](https://github.com/08Ayush/academic_campass_2025/issues)
...
This project represents months of hard work, countless iterations, and collaborative effort from **Team PyGram**. We tackled complex challenges in AI optimization, database architecture, and user experience design to create a production-ready solution for educational institutions.

### Our Vision

To transform timetable scheduling from a tedious manual process to an intelligent, automated system that saves time, reduces conflicts, and enhances the educational experience for thousands of students and faculty members across India.

---

<div align="center">

### Made with ❤️ by Team PyGram
...
![Team](https://img.shields.io/badge/Team-PyGram-blue?style=for-the-badge)

---

⭐ **Star us on GitHub** if you find this project useful!

[Report Bug](https://github.com/08Ayush/academic_campass_2025/issues) • [Request Feature](https://github.com/08Ayush/academic_campass_2025/issues)
