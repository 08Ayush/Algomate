...
interface ClassroomFormData {
  ...
  floor_number?: number;
  capacity: number;
  type: 'lab' | 'seminar' | 'auditorium' | 'lecture';
  equipment?: string;
...
const dummyClassrooms = [
  ...
  // Computer Labs
  {
    ...
    equipment: '30 Computers, Projector, Smart Board, Server Room Access',
    department_id: 1
  },
  {
    id: 4,
    ...
    has_ac: true,
    has_computer_lab: true,
    equipment: '30 Computers, Projector, Smart Board, Network Lab Setup',
    department_id: 1
  },
  {
    id: 5,
    ...
    has_ac: true,
    has_computer_lab: true,
    equipment: '30 Computers, Projector, Smart Board, Software Development Environment',
    department_id: 1
  },
  {
    id: 6,
    ...
    has_ac: true,
    has_computer_lab: true,
    equipment: '30 Computers, Projector, Smart Board, Database Lab Setup',
    department_id: 1
  }
];
...
export default function ClassroomsPage() {
  ...
  const data = (apiData && apiData.length > 0) ? apiData : dummyClassrooms;
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <Select value={formData.type} onValueChange={(value: 'lab' | 'seminar' | 'auditorium' | 'lecture') => setFormData({ ...formData, type: value })}>
            <SelectTrigger>
