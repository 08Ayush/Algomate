...
export default function Index() {
  ...
  const stats = [
    { label: "Active Timetables", value: "8", icon: Calendar, color: "text-blue-600" },
    { label: "Quality Score", value: "94%", icon: TrendingUp, color: "text-green-600" },
    { label: "Faculty Members", value: "15", icon: Users, color: "text-purple-600" },
    { label: "Avg. Generation Time", value: "5.2s", icon: Clock, color: "text-orange-600" }
  ];
      ...
      <section className="relative overflow-hidden rounded-3xl border bg-gradient-to-br from-primary/5 via-blue-50/50 to-indigo-50/50 dark:from-primary/10 dark:via-blue-950/20 dark:to-indigo-950/20 p-8 md:p-12">
        <div className="relative z-10 max-w-4xl">
          ...
          <p className="mt-6 text-xl text-muted-foreground leading-relaxed">
            Revolutionary Automated timetable generation with stylish interface. 
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            {user && isCreatorMentor() && (
              <>
                <Button asChild size="lg" className="rounded-2xl gradient-primary text-white font-semibold hover:scale-105 transition-transform">
                  <Link href="/ai-timetable-creator">
                    <Bot className="h-5 w-5 mr-2" />
                    Create with AI Assistant
                  </Link>
                </Button>
                
                <Button asChild size="lg" className="rounded-2xl bg-gradient-to-r from-purple-500 to-indigo-600 text-white font-semibold hover:scale-105 transition-transform">
                  <Link href="/hybrid-scheduler">
            ...
            {user && isPublisherMentor() && (
              <>
                ...
                <Button asChild size="lg" variant="outline" className="rounded-2xl border-2 border-green-500 text-green-600 hover:scale-105 transition-transform">
                  ...
                  <Card className="modern-card group cursor-pointer">
                    <Link href="/hod-review">
                      <CardContent className="p-6 text-center">
                        ...
                        <h3 className="text-lg font-semibold mb-2">Hybrid Review Queue</h3>
                        <p className="text-sm text-muted-foreground">Review and approve AI-generated timetables from Hybrid Scheduler</p>
                  ...
                  <Card className="modern-card group cursor-pointer">
                    <Link href="/timetables/review">
                      <CardContent className="p-6 text-center">
                        ...
                        <h3 className="text-lg font-semibold mb-2">Standard Review</h3>
                        <p className="text-sm text-muted-foreground">Approve or provide feedback on manually created timetables</p>
