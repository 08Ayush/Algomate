...
// Mock timetable data based on semester - using same format as SemesterTimetableCreator
const getTimetableAssignments = (semester: number) => {
    ...
    3: [
      {
        ...
        day: 'Monday',
        timeSlot: '9:00-10:00',
        subject: { course_code: '25CE301T', course_title: 'Mathematics for Computer Engineering' },
        faculty: { name: 'Dr. Manoj V. Bramhe' },
        classroom: 'A101'
      },
      {
        id: '2',
        ...
        subject: { course_code: '25CE302T', course_title: 'Data Structure' },
        faculty: { name: 'Dr. Sunil M. Wanjari' },
        classroom: 'A102'
      },
      {
        id: '3',
        day: 'Monday',
        timeSlot: '11:20-12:20',
        subject: { course_code: '25CE303T', course_title: 'Digital Circuits' },
        faculty: { name: 'Dr. Dipak W. Wajgi' },
        classroom: 'Lab-1'
      },
      {
        id: '4',
        day: 'Monday',
        timeSlot: '12:20-1:20',
        subject: { course_code: '25CE304T', course_title: 'Computer Architecture' },
        faculty: { name: 'Dr. Komal K. Gehani' },
        classroom: 'B201'
      },
      {
        id: '5',
        day: 'Monday',
        timeSlot: '2:20-3:20',
        subject: { course_code: '25CE302P', course_title: 'Data Structure Lab' },
        faculty: { name: 'Dr. Sunil M. Wanjari' },
        classroom: 'Lab-2'
      },
      {
      ...
      },
      {
        ...
        day: 'Tuesday',
        timeSlot: '2:20-3:20',
        subject: { course_code: '25CE303P', course_title: 'Digital Circuits Lab' },
        faculty: { name: 'Dr. Dipak W. Wajgi' },
        classroom: 'Lab-3'
      },
      {
      ...
      },
      {
        ...
        day: 'Wednesday',
        timeSlot: '12:20-1:20',
        subject: { course_code: '25ES301T', course_title: 'Constitution of India' },
        faculty: { name: 'Dr. Pallavi M. Wankhede' },
        classroom: 'C101'
      },
      {
        id: '15',
        day: 'Wednesday',
        timeSlot: '2:20-3:20',
        subject: { course_code: '25CE305P', course_title: 'Computer Lab-I' },
        faculty: { name: 'Mr. Vaibhav V. Deshpande' },
        classroom: 'Lab-4'
      },
      {
        id: '16',
  ...
  return assignments[semester] || [];
};

// Hybrid-style timetable structure (same as HybridScheduler)
...
export default function StudentDashboard() {
  ...
  const [studentData] = useState<Student>({
    semester: 3, // This would come from user profile
    batch: "A1",
    department: "Computer Science Engineering",
    rollNumber: "22CSE001"
  });

  const assignments = getTimetableAssignments(studentData.semester);
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
                <div>
                  ...
                  <p className="text-red-700">August 18, 2025</p>
                </div>
                <div>
